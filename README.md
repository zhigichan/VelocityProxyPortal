...
От этого мода исходит самая минимальная нагрузка на сервер и на сетевой стёк клиена<br>
Вот баллы нагружености от 0 до 10 - 0.2 (ранче было 1.5)<br>

Мод создан для neoforge 1.21.1 актуальной версии<br>

В этом моде есть фишка создания своего соунтрека<br>
Пожалуста не исползуйте мой мод как машиа соунтреков 👉👈<br>

Мод привязывается автоматически через Bungecoord к прокси Velocity через мод привязки серверов<br>
...
Незабудте после настроки конфигурации прописать команду
```json
/vpp reload
```
...
Конфигурация спавна чатиц скрыта в моём коде для оптимизации сетевого стека и всёравно вам это и ненужно и достаточно этого <br>
...
то ту половину игрок неуслышит (не волнуйтесь никакого звукового бага небудет)<br>
